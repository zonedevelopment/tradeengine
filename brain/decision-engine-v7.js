...
} = require("../services/influence.service");
...
async function evaluateDecision({
    ...
    const phase1Influence = await buildPhase1ContextInfluence({
        symbol: market?.symbol || "XAUUSDm",
        timeframe,
        patternType: pattern?.type || "Unknown",
        side: effectiveSide,
        ...
        volumeProfile: pattern?.volumeProfile || "UNKNOWN",
        rangeState: pattern?.rangeState || "UNKNOWN",
    });

    adaptiveScoreDelta += Number(phase1Influence.scoreDelta || 0);
    ...
    defensiveFlags = {
        ...defensiveFlags,
        warningMatched: Boolean(phase1Influence.warningMatched),
        scorePenalty: Number(phase1Influence.scorePenalty || 0),
        phase1Influence: phase1Influence.details,
    };
